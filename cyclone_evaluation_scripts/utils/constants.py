...
# Track column data for tracks prepared by <REDACTED>
...
SHIPS_metadata = {
    ...
    "SHTD": {  # How is this different from SHTS? SDDC?
        "long_name": "Heading of above shear vector",
        "units": "deg",
        "Notes": "Westerly shear has a value of 90 deg.",
    },
    ...
    "SHTS": {
        "long_name": "Heading of above shear vector",
        "units": "deg",  # verify with
        "Notes": "",  # Should this say 90deg for Westerly shear? verify with
    },
    "PENV": {
    ...
    "PC00": {
        ...
        "units": "Unitless",  # confirm with
        "Notes": "",
        "LeadTimeVar": False,
        "Data_Length": 21,  # confirm with
    },
    "PCM1": {
    ...
    "NDML": {
        ...
        "Notes": """Defined as the depth where the T is 0.5 colder than at the surface. 
                    ...
                    In those cases, NDML is negative.""",  # verify with
    },
    "ND30": {
